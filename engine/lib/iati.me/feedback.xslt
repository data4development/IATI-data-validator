...
<xsl:stylesheet version='3.0' xmlns:xsl='http://www.w3.org/1999/XSL/Transform'
  ...
  <xsl:template match="target/me:feedback|actual/me:feedback" mode="context">
    For the indicator "<em><xsl:apply-templates select="../../../title"/></em>" in the period {../../period-start/@iso-date} to {../../period-end/@iso-date}:
  </xsl:template>
  
  <xsl:template match="period/me:feedback" mode="context">
    In the indicator "<em><xsl:apply-templates select="../../title"/></em>" in the period {../period-start/@iso-date} to {../period-end/@iso-date}:
  </xsl:template>

  <xsl:template match="target/location/me:feedback|actual/location/me:feedback" mode="context">
    For the {name(../..)} location of the indicator "<em><xsl:apply-templates select="../../../../title"/></em>" in the period {../../../period-start/@iso-date} to {../../../period-end/@iso-date}:
  </xsl:template>
